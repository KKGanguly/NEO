...
#from optimizers.PromisetuneOptimizer import PromiseTuneOptimizer
...
def optimize_single_dataset(optimizers, repeats, checkpoints, tmp_output_dir, logging_dir, dataset_file, problem=None, n_vars=None, n_objs=None):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_vars', type=int, default=12)
